...
| 13 | ① | インパクト／KPI：探索30分→3分（体験に基づく目安）、観光の分散、都政への還元 | 「30分は初めてカタログを人手で探した開発メンバーの体験、3分はアプリ操作一巡の目安」と注記（「実測」とは書かない。§1・[Issue #130](https://github.com/fffokazaki/tabi-concierge-tokyo/issues/130)） |
