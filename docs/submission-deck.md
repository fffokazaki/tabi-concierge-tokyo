...
- [ ] **提出フォームに添付する画面キャプチャ 1600×900px を1〜3点用意する** ―― **未実施**。本書冒頭の提出仕様・[CONSTRAINTS.md](01-context/CONSTRAINTS.md) §7 で変更不可の規定。**資料に埋め込む 480×874 の端末フレーム画像とは別物**で、そちらを添付しても規定を満たさない。撮り直した3画面と同じ操作条件（興味チップのみ・自由文は空）で、1600×900 のキャンバスに収める形で用意する
